                ...
                <div class="col-12">
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product-price-cart"><span class="amount"><i class="fas fa-rupee"></i>60.00</span></td>
                                    <td class="product-quantities">
                                        <div class="quantity d-inline-block">
                                            <input type="number" min="1" step="1" value="1">
                                        </div>
                                    </td>
                                    <td class="product-subtotal"><i class="fas fa-rupee"></i>70.00</td>
                                ...
                                <tr>
                                    ...
                                    <td class="product-name"><a href="#">Product Name</a></td>
                                    <td class="product-price-cart"><span class="amount"><i class="fas fa-rupee"></i>50.00</span></td>
                                    <td class="product-quantities">
                                        <div class="quantity d-inline-block">
                                            <input type="number" min="1" step="1" value="1">
                                        </div>
                                    </td>
                                    <td class="product-subtotal"><i class="fas fa-rupee"></i>80.00</td>
                                    <td class="product-remove">
                                        <a href="#"><i class="fa fa-pencil-alt"></i></a>
                                        <a href="#"><i class="fa fa-times"></i></a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="product-name"><a href="#">Product Name</a></td>
                                    <td class="product-price-cart"><span class="amount"><i class="fas fa-rupee"></i>70.00</span></td>
                                    <td class="product-quantities">
                                        <div class="quantity d-inline-block">
                                            <input type="number" min="1" step="1" value="1">
                                        </div>
                                    </td>
                                    <td class="product-subtotal"><i class="fas fa-rupee"></i>90.00</td>
                                    <td class="product-remove">
                                        <a href="#"><i class="fa fa-pencil-alt"></i></a>
                                        <a href="#"><i class="fa fa-times"></i></a>
                                    </td>
                    ...
                    <div class="cart-table-button m-t-10">
                        ...
                        <div class="cart-table-button--right">
                            ...
                            <a href="./empty-cart.php" class="btn btn--box btn--large btn--radius btn--black btn--black-hover-green btn--uppercase font--bold m-t-20">Clear Shopping Cart</a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="sidebar__widget m-t-40">
                        ...
                        <form action="#" method="post" class="form-box">
                            <div class="form-box__single-group">
                                <label for="form-coupon">Enter Coupon Code (Optional)</label>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="sidebar__widget m-t-40">
                        ...
                        <h6 class="total-cost">Total products Price<span><i class="fas fa-rupee"></i>260.00</span></h6>
                        <div class="total-shipping">
                            ...
                            <ul class="shipping-cost m-t-10">
                                <li>
                                    ...
                                    <span class="ship-price"><i class="fas fa-rupee"></i> 20.00</span>
                                </li>
                                <li>
                                    ...
                                    <span class="ship-price"><i class="fas fa-rupee"></i>30.00</span>
                                </li>
                            </ul>
                        </div>
                        <h4 class="grand-total m-tb-25">Grand Total <span><i class="fas fa-rupee"></i>260.00</span></h4>
