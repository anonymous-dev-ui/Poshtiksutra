        ...
        <div class="row">
            <div class="col-12">
                <ul class="page-breadcrumb__menu">
                    ...
                    <li class="page-breadcrumb__nav active">Shop</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row flex-column-reverse flex-lg-row">
            ...
            <div class="col-lg-3">
                <div class="sidebar">
                            ...
                            <li>
                                <ul class="sidebar__menu-collapse">
                                    ...
                                    <li class="sidebar__menu-collapse-list">
                                        <div class="accordion">
                                            <a href="#" class="accordion__title collapsed" data-toggle="collapse" data-target="#men-fashion" aria-expanded="false">Herbal <i class="far fa-chevron-down"></i></a>
                                            <div id="men-fashion" class="collapse">
                                                <ul class="accordion__category-list">
                                                    <li><a href="#">Herbal Pak</a></li>
                                                    <li><a href="#">Herbal Water</a></li>
                    ...
                    <div class="sidebar__widget">
                        <div class="sidebar__box">
                            <h5 class="sidebar__title">Weight (Grams)</h5>
                        </div>
                        <ul class="sidebar__size list-space--small">
                            <li><a class="btn btn--box btn--tiny btn--radius-tiny btn--border-gray btn--border-gray-hover-green" href="#">50</a></li>
                            <li><a class="btn btn--box btn--tiny btn--radius-tiny btn--border-gray btn--border-gray-hover-green" href="#">100</a></li>
                            <li><a class="btn btn--box btn--tiny btn--radius-tiny btn--border-gray btn--border-gray-hover-green" href="#">200</a></li>
                            <li><a class="btn btn--box btn--tiny btn--radius-tiny btn--border-gray btn--border-gray-hover-green" href="#">250</a></li>
                            <li><a class="btn btn--box btn--tiny btn--radius-tiny btn--border-gray btn--border-gray-hover-green" href="#">500</a></li>
                            <li><a class="btn btn--box btn--tiny btn--radius-tiny btn--border-gray btn--border-gray-hover-green" href="#">1000</a></li>
                            <li><a class="btn btn--box btn--tiny btn--radius-tiny btn--border-gray btn--border-gray-hover-green" href="#">5000</a></li>
                    ...
                    <!-- End Single Sidebar Widget - Filter [Gender] -->
                    ...
                    <div class="sidebar__widget">
                        <div class="sidebar__box">
                            <h5 class="sidebar__title">FILTER BY Price ( <i class="fas fa-rupee"></i> )</h5>
                        </div>
                        ...
                        <ul class="sidebar__post-product list-space--medium ">
                            <li class="d-flex align-items-center">
                                ...
                                <div class="product__content">
                                    <a href="product-single-default.html" class="product__link">Mustered Oil</a>
                                    ...
                                    <div class="product__price">
                                        <span class="product__price"><i class="fas fa-rupee"></i>10.00</span>
                                    </div>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                ...
                                <div class="product__content">
                                    <a href="product-single-default.html" class="product__link">Yellow Mustered Oil</a>
                                    <ul class="product__review">
                                        <li class="product__review--fill"><i class="icon-star"></i></li>
                                        <li class="product__review--fill"><i class="icon-star"></i></li>
                                        <li class="product__review--fill"><i class="icon-star"></i></li>
                                    ...
                                    <div class="product__price">
                                        <span class="product__price"><i class="fas fa-rupee"></i>17.00</span>
                                    </div>
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <!-- Start Product Content -->
                                <div class="product__content">
                                    <a href="product-single-default.html" class="product__link">Coconet oil</a>
                                    <ul class="product__review">
                                        <li class="product__review--fill"><i class="icon-star"></i></li>
                                        <li class="product__review--fill"><i class="icon-star"></i></li>
                                        <li class="product__review--fill"><i class="icon-star"></i></li>
                                    ...
                                    <div class="product__price">
                                        <span class="product__price"><i class="fas fa-rupee"></i>25.00</span>
                                    </div>
                                </div> <!-- End Product Content -->
                            </li>
                        </ul>
                    ...
                    <div class="sort-box-item">
                        <div class="sort-box__tab">
                            <ul class="sort-box__tab-list nav">
                                <li><a class="sort-nav-link" data-toggle="tab" href="#sort-grid"><i class="fas fa-th"></i> </a></li>
                                <li><a class="sort-nav-link active" data-toggle="tab" href="#sort-list"><i class="fas fa-list-ul"></i></a></li>
                            </ul>
                        </div>
